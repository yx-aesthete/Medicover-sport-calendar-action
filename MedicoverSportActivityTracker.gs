...
var backup_folder_name = "YOUR-BACKUP-FOLDER-NAME"; // Change this to the name of your backup folder on your google drive
// e.x. "sms"
var calendarId = "YOUR-CALENDAR-ID"; // Change this to the ID of your calendar
// e.x. "qwertzuiopasdfghjklyxcvbnm@group.calendar.google.com" if your calendar ID 
